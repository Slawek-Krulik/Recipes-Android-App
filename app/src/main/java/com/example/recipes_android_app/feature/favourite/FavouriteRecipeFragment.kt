package com.example.recipes_android_app.feature.favourite
...
class FavouriteRecipeFragment: BaseFragment<RecipeViewModel>(R.layout.fragment_favourite_recipe) {
